...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMore() {
        ...
        .then(html => {
            ...
            if (newItems.length > 0) {
                ...
                if (!nextPage) {
                    ...
                    loadingIndicator.innerHTML = '<p class="text-gray-500 dark:text-gray-400">No more records</p>';
        ...
        .catch(error => {
            ...
            loadingIndicator.innerHTML = '<p class="text-red-500 dark:text-red-400">Error loading more records</p>';
            setTimeout(() => loadingIndicator.classList.add('hidden'), 2000);
        })
        .finally(() => {
            loading = false;
