        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-white">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Global Summary</h2>
                ...
                <form method="POST" action="{{ route('sdc.update-global-summary', $globalSummary->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mb-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="mt-1 text-lg font-medium text-gray-900 dark:text-white">{{ $globalSummary->application_no }}</div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Customer Name</label>
                                        <div class="mt-1 text-lg font-medium text-gray-900 dark:text-white">{{ $globalSummary->customer_name }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="sim_number" id="sim_number" value="{{ old('sim_number', $globalSummary->sim_number) }}" 
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="consumer_address" id="consumer_address" rows="3"
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">{{ old('consumer_address', $globalSummary->consumer_address) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_on_draft_store" id="date_on_draft_store" value="{{ old('date_on_draft_store', $globalSummary->date_on_draft_store?->format('Y-m-d')) }}" 
                        ...
                        <div>
                            ...
                            <input type="date" name="date_received_lm_consumer" id="date_received_lm_consumer" value="{{ old('date_received_lm_consumer', $globalSummary->date_received_lm_consumer?->format('Y-m-d')) }}" 
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="customer_mobile_no" id="customer_mobile_no" value="{{ old('customer_mobile_no', $globalSummary->customer_mobile_no) }}" 
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" 
                        ...
                        <div>
                            ...
                            <input type="text" name="customer_sc_no" id="customer_sc_no" value="{{ old('customer_sc_no', $globalSummary->customer_sc_no) }}" 
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_return_sdc_billing" id="date_return_sdc_billing" value="{{ old('date_return_sdc_billing', $globalSummary->date_return_sdc_billing?->format('Y-m-d')) }}" 
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                    </div>
