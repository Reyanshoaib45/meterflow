    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-6">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="{{ route('application.invoice.download', $application->application_no) }}" class="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition shadow-lg hover:shadow-xl text-center">
